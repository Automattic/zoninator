...
/**
 * Class Zoninator_REST_Class_Loader
 */
class Zoninator_REST_Classloader implements Zoninator_REST_Interfaces_Classloader {
	/**
	...
	/**
	 * Zoninator_REST_Class_Loader constructor.
	 *
