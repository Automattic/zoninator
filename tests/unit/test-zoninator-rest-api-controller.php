...
class Zoninator_Rest_Api_Controller_Test extends WP_UnitTestCase
{
    ...
    function setUp()
    {
        ...
        $this->_zoninator = $this->getMockBuilder( 'Zoninator' )
            ->disableOriginalConstructor()
            ->getMock();

        $this->_controller = new Zoninator_Rest_Api_Controller( $this->_zoninator );
    ...
    function test_add_post_to_zone_return_WP_Error_if_no_zone()
    {
        ...
        $this->_zoninator->method( 'get_zone' )->willReturn(null);
    ...
    function test_add_post_to_zone_500_if_add_zone_posts_Fails()
    {
        ...
        $this->_zoninator->method( 'get_zone' )->willReturn( new stdClass() );
        $this->_zoninator->method( 'add_zone_posts' )->willReturn( new WP_Error( 'an-error' ) );
        $response = $this->_controller->add_post_to_zone( $request );
    ...
    function test_add_post_to_zone_200_if_add_zone_posts_succeeds()
    {
        $request = $this->_create_request( array( 'post_id' => $this->_post_id, 'zone_id' => 3 ) );
        $this->_zoninator->method( 'get_zone' )->willReturn( new stdClass() );
        $this->_zoninator->method( 'add_zone_posts' )->willReturn( null );
        $response = $this->_controller->add_post_to_zone( $request );
    ...
    {
        $request = $this->_create_request( array( 'post_id' => $this->_post_id, 'zone_id' => 3 ) );
        $this->_zoninator->method( 'remove_zone_posts' )->willReturn( null );
        $response = $this->_controller->remove_post_from_zone( $request );
        $this->_assert_response_status($response, 200);
    }
    ...
    function test_reorder_posts_on_zone_return_200_if_zone_id_and_posts_present()
    {
        ...
        $this->_zoninator->method( 'add_zone_posts' )->willReturn( new stdClass() );
        $response = $this->_controller->reorder_posts( $request );
        $this->_assert_response_status($response, 200);
    }
    ...
    {
        $request = $this->_create_request( array( 'zone_id' => 3, 'posts' => array( 1, 3, 6 ) ) );
        $this->_zoninator->method( 'add_zone_posts' )->willReturn( new WP_Error('my-error') );
        $response = $this->_controller->reorder_posts( $request );
    ...
    {
        $request = $this->_create_request( array( 'zone_id' => 3 ) );
        $this->_zoninator->method( 'get_zone_feed' )->willReturn( new WP_Error( 'en-error' ) );
        $this->_zoninator->method( 'get_zone' )->willReturn( array(1) );
    ...
    {
        $request = $this->_create_request( array( 'zone_id' => 3 ) );
        $this->_zoninator->method( 'get_zone_feed' )->willReturn( array() );
        $this->_zoninator->method( 'get_zone' )->willReturn( array(1) );
        $response = $this->_controller->get_zone_posts( $request );
        $this->_assert_response_status($response, 200);
    }
    ...
    function test_get_zone_feed_errors_if_no_zone_id()
    {
        ...
        $this->_zoninator->method( 'get_zone_feed' )->willReturn( array() );
        $this->_zoninator->method( 'get_zone' )->willReturn( array() );
        $response = $this->_controller->get_zone_posts( $request );
        $this->assertInstanceOf( 'WP_Error', $response );
    }
    ...
    {
        $this->_zoninator->method( 'remove_post' )->willReturn( null );
        $request = $this->_create_request( array( 'post_id' => $this->_post_id, 'zone_id' => 3 ) );
        $response = $this->_controller->remove_post_from_zone( $request );
        $this->_assert_response_status($response, 200);
    }
    ...
    {
        $this->_zoninator->method( 'remove_zone_posts' )->willReturn( new WP_Error('error') );
        $request = $this->_create_request( array( 'post_id' => $this->_post_id, 'zone_id' => 3 ) );
        $response = $this->_controller->remove_post_from_zone( $request );
        $this->_assert_response_status($response, 500);
    }
    ...
    {
        $this->_zoninator->method( 'add_zone_posts' )->willReturn( new WP_Error('error') );
        $request = $this->_create_request( array( 'posts' => array( $this->_post_id ), 'zone_id' => 3 ) );
        $response = $this->_controller->reorder_posts( $request );
        $this->_assert_response_status($response, 500);
    }
